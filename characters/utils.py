...
class CharacterValidator:
    """Classe per validazioni dei personaggi."""
    ...
    def validate_character_class(classe: str) -> Tuple[bool, str]:
        ...
        Returns:
            Tuple[bool, str]: (is_valid, error_message)
        """
        available_classes = CharacterValidator.get_character_classes()
...
class CharacterManager:
    """Classe per operazioni CRUD sui personaggi."""
    
    @staticmethod
    def save_character_json(character_dict: Dict) -> bool:
        """
    ...
    @staticmethod
    def load_character_json(char_id: str) -> Optional[Dict]:
        """
    ...
    @staticmethod
    def delete_character_json(char_id: str) -> bool:
        """
    ...
    def filter_owned_characters(user_char_ids: List[str]) -> List[str]:
        ...
        all_files = CharacterManager.get_user_character_files()
    ...
    @staticmethod
    def load_multiple_characters_json(char_ids: List[str]) -> List[Dict]:
        """
        ...
        for char_id in char_ids:
            char_data = CharacterManager.load_character_json(char_id)
            if char_data:
...
class CharacterStatsCalculator:
    """Classe per calcolo statistiche dei personaggi."""
    
    @staticmethod
    def get_user_character_count(user_char_ids: List[str]) -> int:
        """
    ...
    @staticmethod
    def get_user_character_stats_by_class(user_char_ids: List[str]) -> Dict[str, int]:
        """
    ...
    @staticmethod
    def get_most_played_class(user_char_ids: List[str]) -> Tuple[str, int]:
        """
        ...
        """
        stats = CharacterStatsCalculator.get_user_character_stats_by_class(user_char_ids)
    ...
    @staticmethod
    def get_character_distribution(user_char_ids: List[str]) -> Dict[str, float]:
        """
...
class CharacterCombat:
    """Classe per gestione combattimenti."""
...
class CharacterLogger:
    """Classe per logging e debug personaggi."""
