...
class InventoryValidator:
    """Classe per validazioni degli inventari e oggetti."""
    ...
    def validate_object_class(object_name: str) -> Tuple[bool, str]:
        ...
        """
        available_objects = InventoryValidator.get_object_classes()
...
class InventoryManager:
    """Classe per operazioni CRUD sugli inventari."""
    
    @staticmethod
    def save_inventory_json(inventario: Inventario) -> bool:
        """
    ...
    @staticmethod
    def load_inventory_json(personaggio_id: str) -> Optional[Dict]:
        """
        ...
        return InventoryManager._search_inventory_by_owner(personaggio_id)
    
    @staticmethod
    def _search_inventory_by_owner(personaggio_id: str) -> Optional[Dict]:
        """
    ...
    @staticmethod
    def delete_inventory_json(personaggio_id: str) -> bool:
        """
    ...
    @staticmethod
    def get_all_inventory_files() -> List[str]:
        """
    ...
    def create_custom_object(object_type: str, nome: str, valore: int = 0) -> Oggetto:
        ...
        """
        oggetto = InventoryManager.create_object_instance(object_type)
        oggetto.nome = nome
...
class InventoryOperations:
    """Classe per operazioni sugli oggetti degli inventari."""
    ...
    def add_object_to_inventory(inventario_data: Dict, nuovo_oggetto: Oggetto) -> Tuple[bool, str]:
        ...
        try:
            ...
            # Salva su file
            if InventoryManager.save_inventory_json(inventario_obj):
    ...
    @staticmethod
    def find_objects_in_inventory(inventario_data: Dict, criteria: Dict) -> List[Dict]:
        """
...
class InventoryStatsCalculator:
    """Classe per calcolo statistiche degli inventari."""
    
    @staticmethod
    def get_inventory_item_count(inventario_data: Dict) -> int:
        """
    ...
    @staticmethod
    def get_inventory_value_total(inventario_data: Dict) -> int:
        """
    ...
    @staticmethod
    def get_inventory_stats_by_type(inventario_data: Dict) -> Dict[str, int]:
        """
...
class InventoryLogger:
    """Classe per logging e debug inventari."""
    ...
    def get_inventory_debug_info(inventario_data: Dict) -> Dict:
        ...
        try:
            return {
                ...
                'valore_totale': InventoryStatsCalculator.get_inventory_value_total(inventario_data),
                'tipi_oggetti': list(InventoryStatsCalculator.get_inventory_stats_by_type(inventario_data).keys()),
                'oggetti_dettagli': [
                    {
